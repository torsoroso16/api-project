...
import settingJson from 'src/modules/settings/settings.json';
import paymentGatewayJson from 'src/modules/payment-method/payment-gateway.json';
import { PaymentGateWay } from 'src/modules/payment-method/entities/payment-gateway.entity';
