...
import { StripePaymentService } from '../payment/services/stripe-payment.service';
import { PaypalPaymentService } from '../payment/services/paypal-payment.service';
import settingJson from '../settings/settings.json';
import paymentIntentJson from '../payment-intent/payment-intent.json';
import paymentGatewayJson from '../payment-method/payment-gateway.json';
